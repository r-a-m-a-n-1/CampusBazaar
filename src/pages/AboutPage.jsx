...
import { AiFillHeart } from 'react-icons/ai'; // Heart icon
import { FaCopyright } from 'react-icons/fa'; // Copyright icon
import { FaInstagram, FaWhatsapp, FaFacebook } from 'react-icons/fa'; // Instagram, WhatsApp, Facebook icons
    ...
    >
      ...
      <footer className="w-screen bg-gray-900 py-6">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="flex items-center space-x-6">
            <a
              href="https://www.instagram.com/invites/contact/?igsh=1n0px9z1vfiqo&utm_content=vyohu8"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-pink-600"
            >
