...
// import ViewProfile from "./pages/ViewProfilePage"; // Import the ViewProfile component
// import LoadingSpinner from "./components/LoadingSpinner";
// import { Toaster } from "react-hot-toast";
// import { useAuthStore } from "./store/authStore";
// import { ProductProvider } from "./store/productStore";
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-900 to-emerald-900 flex flex-col items-center relative overflow-hidden">
//       {/* Conditionally render Navbar only when not on any profile route */}
//       {location.pathname !== '/profile' && 
//        location.pathname !== '/viewprofile' &&  // Add condition to hide Navbar on /viewprofile
//        location.pathname !== '/login' &&
//        location.pathname !== '/signup' &&
//        location.pathname !== '/forgot-password' &&
//        !location.pathname.startsWith('/reset-password/') && 
...
// import { useAuthStore } from "./store/authStore";
// import { ProductProvider } from "./store/productStore";
// import BuyPage from "./pages/BuyPage"; // Import BuyPage
...
import TechTitaniumTeam from "./pages/TechTitaniumTeam"; // Import the TechTitaniumTeam component
